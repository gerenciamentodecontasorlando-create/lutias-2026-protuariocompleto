...
/* =========================================================
   NOVO (ÚNICA FEATURE ADICIONADA): PDF DA FICHA CLÍNICA
   - Puxa dados do paciente
   - Puxa evolução atual (caixa Observações/Evolução)
   - Inclui prescrição do campo de receita
   - Mantém bordas + marca discreta + assinatura + data
   ========================================================= */
